...
import "./Cart.css"
// import { DELETE, ADD, REMOVE } from '../Redux/auth/action';
 ...
 const Cart = () => {
    ...
    var cart
    cart = JSON.parse(localStorage.getItem("FraazoCart")) || [];
    useEffect(()=> {
        total();
    }, [total])
               ...
               <div className="cart-items">
                   {cart.map(cartItem => {
                       return (
                        ...
                        <div className="cart-product-total-price">33763</div>
                     </div>
                               ...
                               <div className="cart-checkout">
                                   <div className="subtotal">
                                       <span>Subtotal</span>
                                       <span className="amount">₹ 33763</span>
                                   </div>
